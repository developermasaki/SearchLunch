        ...
        results = Results(
            ...
            shop = listOf(
                Shop(
                    ...
                    open = "月～日、祝日、祝前日: 11:30～23:30 （料理L.O. 22:00 ドリンクL.O. 23:00）",
                    close = "無休 （※12月31日、1月1日はお休みを頂戴いたします。）昼宴会・2次会など大歓迎♪",
                ...
                Shop(
                    ...
                    open = "月～木、日、祝日: 17:00～翌2:00 （料理L.O. 23:30 ドリンクL.O. 翌1:00）金、土、祝前日: 17:00～翌5:00 （料理L.O. 翌2:00 ドリンクL.O. 翌4:00）",
                    close = "※【年末年始】12月31日～1月2日はお休みとなります。※NET予約なら24時間ご予約受付中！",
                    otherMemo = "",
